...
public task_check_time()
{
	...
	if (equal(a, "00:00"))	server_cmd("amx_map de_dust2x2")
	if (equal(a, "00:05"))
	{
		...
		register_clcmd("amx_votemap","VOTEMAP")
	}
